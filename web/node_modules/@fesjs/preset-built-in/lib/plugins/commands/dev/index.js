...
var _default = api => {
  ...
  api.registerCommand({
    ...
    async fn({
      ...
      var _api$config$devServer, _api$config$devServer2;
      ...
      const defaultPort = process.env.PORT || args.port || ((_api$config$devServer = api.config.devServer) === null || _api$config$devServer === void 0 ? void 0 : _api$config$devServer.port);
      port = await portfinder.getPortPromise({
        port: defaultPort ? parseInt(String(defaultPort), 10) : 8000
      });
      hostname = process.env.HOST || ((_api$config$devServer2 = api.config.devServer) === null || _api$config$devServer2 === void 0 ? void 0 : _api$config$devServer2.host) || 'localhost';
      process.send({
        type: 'UPDATE_PORT',
        port
      }); // enable https
