...
exports.default = createCssWebpackConfig;
...
function createRules({
  ...
  function applyLoaders(rule, isCSSModules) {
    ...
    rule.use('css-loader').loader(require.resolve('css-loader')).options((0, _utils.deepmerge)({
      importLoaders: 1,
    ...
    rule.use('postcss-loader').loader(require.resolve('postcss-loader')).options((0, _utils.deepmerge)({
      postcssOptions: () => ({
        ...
        require('postcss-flexbugs-fixes'), require('postcss-safe-parser'), [require('autoprefixer'), { ...config.autoprefixer,
...
function createCssWebpackConfig({
  isDev,
  config,
  webpackConfig,
  browserslist
