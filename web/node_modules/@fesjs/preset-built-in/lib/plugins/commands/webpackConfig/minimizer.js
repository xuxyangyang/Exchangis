...
exports.default = createMinimizerWebpackConfig;
...
const terserOptions = config => ({
  terserOptions: (0, _utils.deepmerge)(defaultTerserOptions, config.terserOptions || {}),
  extractComments: false
});

function createMinimizerWebpackConfig({
  isProd,
  config,
  webpackConfig
}) {
