...
var _default = api => {
  ...
  api.chainWebpack(webpackConfig => {
    ...
    webpackConfig.plugin('bundle-analyzer').use(require('webpack-bundle-analyzer').BundleAnalyzerPlugin, [((_api$config = api.config) === null || _api$config === void 0 ? void 0 : _api$config.analyze) || {}]);
