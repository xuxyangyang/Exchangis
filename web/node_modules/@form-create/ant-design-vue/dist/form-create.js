...
(function (global, factory) {
  ...
  var _hoisted_2$8 = /*#__PURE__*/vue.createElementVNode("svg", {
    height: "1em",
    width: "1em",
  ...
  function render$8(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("span", _hoisted_1$8, _hoisted_3$8);
  }
  ...
  var Upload = vue.defineComponent({
    ...
    render: function render() {
      ...
      return vue.createVNode(vue.Fragment, null, [vue.createVNode(vue.resolveComponent("AUpload"), vue.mergeProps({
        ...
        "default": function _default() {
          return [isShow ? ((_this$$slots$default = (_this$$slots = _this.$slots)["default"]) === null || _this$$slots$default === void 0 ? void 0 : _this$$slots$default.call(_this$$slots)) || vue.createVNode(script$8, {
  ...
  var _hoisted_2$7 = /*#__PURE__*/vue.createElementVNode("svg", {
    height: "1em",
    width: "1em",
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 1024 1024"
  ...
  function render$7(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("span", _hoisted_1$7, _hoisted_3$7);
  }
  ...
  var _hoisted_2$6 = /*#__PURE__*/vue.createElementVNode("svg", {
    height: "1em",
    width: "1em",
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 1024 1024"
  ...
  function render$6(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("span", _hoisted_1$6, _hoisted_3$6);
  }
  ...
  var _hoisted_2$5 = /*#__PURE__*/vue.createElementVNode("svg", {
    height: "1em",
    width: "1em",
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 1024 1024"
  ...
  function render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("span", _hoisted_1$5, _hoisted_3$5);
  }
    ...
    methods: {
      ...
      makeInput: function makeInput() {
        ...
        if (this.fileList.length) {
          slots.suffix = function () {
            return vue.createVNode(script$7, {
              "class": "_fc-frame-icon",
      ...
      makeFiles: function makeFiles() {
        ...
        return this.makeGroup(this.fileList.map(function (src, index) {
          return _this4.makeItem(index, [vue.createVNode(script$5, {
            "class": "_fc-frame-icon",
            "onClick": function onClick() {
      ...
      watchCtx: function watchCtx(ctx) {
        ...
        if (ctx.input) {
          ...
          this.bus.$once('load-end', function () {
            var computedRef = vue.toRef(ctx.rule, 'computed');
            ctx.watch.push(vue.watch(function () {
  ...
  function FormCreateFactory(config) {
    ...
    function FormCreate(vm) {
      ...
      extend(this, {
        ...
        bus: new Mitt(),
        unwatch: null,
        options: vue.ref(vm.props.option || {}),
