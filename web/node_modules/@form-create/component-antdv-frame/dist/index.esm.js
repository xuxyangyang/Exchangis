 ...
 */
import { openBlock, createElementBlock, createElementVNode, defineComponent, resolveComponent, createVNode, isVNode, nextTick, mergeProps } from 'vue';
...
var Frame = defineComponent({
  ...
  methods: {
    ...
    makeFiles: function makeFiles() {
      ...
      return this.makeGroup(this.fileList.map(function (src, index) {
        return _this4.makeItem(index, [createVNode(script$2, {
          "class": "_fc-frame-icon",
          "onClick": function onClick() {
  ...
  render: function render() {
    ...
    }), createVNode(resolveComponent("aModal"), mergeProps(_objectSpread2({
      width: width,
      title: title
    }, this.modal), {
